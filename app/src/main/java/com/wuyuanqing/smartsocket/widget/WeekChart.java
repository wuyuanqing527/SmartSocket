...
public class WeekChart extends DemoView {
    ...
    public WeekChart(Context context, AttributeSet attrs, int defStyle) {
        ...
        if(!chart.getListenItemClickStatus())
        {
            ...
            while(it.hasNext())
            {
                ...
                if (pos == i) {
                    ...
                    chart.getToolTip().addToolTip("666",pToolTip);
